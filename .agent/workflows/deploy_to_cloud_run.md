...
gcloud run deploy bank-to-ynab \
  ...
  --concurrency=80 \
  --timeout=120s \
  --set-env-vars=PYTHONUNBUFFERED=1,GOOGLE_CLOUD_PROJECT=antigravity-bank-ynab,GCP_PUBSUB_TOPIC=projects/antigravity-bank-ynab/topics/gmail-notifications,EVENTBUS_BACKEND=pubsub,SESSION_BACKEND=firestore,MEMORY_BACKEND=firestore,ARTIFACT_BACKEND=gcs,ARTIFACT_GCS_BUCKET=antigravity-bank-ynab-artifacts,RUN_LOG_BACKEND=firestore,INGESTION_MODE=push,MODEL_RATE_LIMIT_QPM=1500,CONTEXT_CACHE_MIN_TOKENS=2048,CONTEXT_CACHE_TTL_SECONDS=1800,CONTEXT_CACHE_INTERVALS=10,CONTEXT_COMPRESSION_TRIGGER_TOKENS=100000,CONTEXT_COMPRESSION_TARGET_TOKENS=80000,HASS_URL=https://home-assistant.camilo-systems.com \
